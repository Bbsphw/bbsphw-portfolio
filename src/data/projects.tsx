...
export const projectsData: LocalizedData<Project[]> = {
  en: [
    ...
    // ---------------- PROJECT 3: BunLux Nail (EN) ----------------
    {
      ...
      technologies: ["React", "Expo", "Supabase", "TypeScript", "Mobile"],
  ...
  th: [
    ...
    // Project 5: TiawPao (TH)
    {
      ...
      category: "Web App",
      description:
        "ระบบหลังบ้านสำหรับแอปพลิเคชันท่องเที่ยว 'เที่ยวเปล่า' จัดการผู้ใช้งาน เนื้อหา และวิเคราะห์ข้อมูล",
      role: "Frontend Developer",
      date: "ส.ค. 2567 - ก.ย. 2567",
      overview:
        "โปรเจกต์นี้เป็นแผงควบคุม (Control Panel) สำหรับผู้ดูแลระบบแอปเที่ยวเปล่า ช่วยให้แอดมินจัดการบัญชีผู้ใช้ ตรวจสอบสถานะระบบ และวิเคราะห์เทรนด์การวางแผนท่องเที่ยว Dashboard ถูกออกแบบมาให้รองรับข้อมูลจำนวนมาก (Scalability) และใช้งานง่าย พร้อมการแสดงผลข้อมูลแบบ Real-time",
      features: [
