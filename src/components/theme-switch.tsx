...
export default function ThemeSwitch() {
  ...
  if (!mounted) {
    return (
      <div className="flex h-8 w-16 items-center justify-start rounded-full bg-zinc-200 p-1 dark:justify-end dark:bg-zinc-800">
        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-white shadow-sm dark:bg-zinc-950">
          ...
          <Moon className="hidden h-3.5 w-3.5 fill-zinc-300 text-zinc-300 dark:block" />
        </div>
      </div>
    );
  }
